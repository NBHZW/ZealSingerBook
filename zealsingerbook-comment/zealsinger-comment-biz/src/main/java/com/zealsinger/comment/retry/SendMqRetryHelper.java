package com.zealsinger.comment.retry;
...
public class SendMqRetryHelper {
    ...
    /*
    原本的想法能简化开发 结果想起来retry底层是AOP 同方法内直接调用触发不了AOP
    public void asySend(String topic, String body) {
        log.info("==> 开始异步发送(func 2) MQ, Topic: {}, Body: {}", topic, body);
    ...
    public void send(String topic, Message<String> message) {
        log.info("==> 开始异步发送(func 2) MQ, Topic: {}, publishCommentMqDTO: {}", topic, message);
